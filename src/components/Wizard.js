...
class App extends React.Component {
  ...
  render() {
    ...
    const resultsComponent = completed ? (
      <Results results={results} treeResult={treeResult} />
    ) : null;

    const button = !completed ? (
      <Button onClick={this.submitChoice} isActive={continueDisabled} />
    ) : null;
    ...
    return (
      <div className="App">
        ...
        <div className="App-container">
          ...
          {/* BUTTON  */}
          <div className="bottone">{button}</div>
